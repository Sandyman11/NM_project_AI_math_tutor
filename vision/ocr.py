...
def llm_convert_to_latex(ocr_text: str, image=None, model="gpt-4o-mini") -> str:
    ...
    gemini_key = os.getenv("AIzaSyC3j3JzEjCYWF9mD0s9KBZnRaYRnKBg45w")
    if gemini_key:
        try:
    ...
    api_key = os.getenv("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")
